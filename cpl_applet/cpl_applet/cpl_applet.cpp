...
// cpl_applet.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CcplappletApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CcplappletApp

CcplappletApp::CcplappletApp()
{
...
// Единственный объект CcplappletApp

CcplappletApp theApp;


// Инициализация CcplappletApp

BOOL CcplappletApp::InitInstance()
{
